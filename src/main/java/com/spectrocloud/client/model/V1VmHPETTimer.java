...
public class V1VmHPETTimer {
  ...
  public V1VmHPETTimer present(Boolean present) {
  ...
  **/
  ...
  public V1VmHPETTimer tickPolicy(String tickPolicy) {
   ...
   * @return tickPolicy
  **/
  @Schema(description = "TickPolicy determines what happens when QEMU misses a deadline for injecting a tick to the guest. One of \"delay\", \"catchup\", \"merge\", \"discard\".")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1VmHPETTimer v1VmHPETTimer = (V1VmHPETTimer) o;
    return Objects.equals(this.present, v1VmHPETTimer.present) &&
        Objects.equals(this.tickPolicy, v1VmHPETTimer.tickPolicy);
  }
