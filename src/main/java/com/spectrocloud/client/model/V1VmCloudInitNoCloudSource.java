 ...
 */
@Schema(description = "Represents a cloud-init nocloud user data source. More info: http://cloudinit.readthedocs.io/en/latest/topics/datasources/nocloud.html")


public class V1VmCloudInitNoCloudSource {
  ...
  public V1VmCloudInitNoCloudSource networkData(String networkData) {
   ...
   * @return networkData
  **/
  @Schema(description = "NetworkData contains NoCloud inline cloud-init networkdata.")
  ...
  public V1VmCloudInitNoCloudSource networkDataBase64(String networkDataBase64) {
  ...
  **/
  @Schema(description = "NetworkDataBase64 contains NoCloud cloud-init networkdata as a base64 encoded string.")
  ...
  public V1VmCloudInitNoCloudSource networkDataSecretRef(V1VmLocalObjectReference networkDataSecretRef) {
  ...
  **/
  ...
  public V1VmCloudInitNoCloudSource secretRef(V1VmLocalObjectReference secretRef) {
  ...
  **/
  ...
  public V1VmCloudInitNoCloudSource userData(String userData) {
   ...
   * @return userData
  **/
  @Schema(description = "UserData contains NoCloud inline cloud-init userdata.")
  ...
  public V1VmCloudInitNoCloudSource userDataBase64(String userDataBase64) {
  ...
  **/
  @Schema(description = "UserDataBase64 contains NoCloud cloud-init userdata as a base64 encoded string.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1VmCloudInitNoCloudSource v1VmCloudInitNoCloudSource = (V1VmCloudInitNoCloudSource) o;
    return Objects.equals(this.networkData, v1VmCloudInitNoCloudSource.networkData) &&
        Objects.equals(this.networkDataBase64, v1VmCloudInitNoCloudSource.networkDataBase64) &&
        Objects.equals(this.networkDataSecretRef, v1VmCloudInitNoCloudSource.networkDataSecretRef) &&
        Objects.equals(this.secretRef, v1VmCloudInitNoCloudSource.secretRef) &&
        Objects.equals(this.userData, v1VmCloudInitNoCloudSource.userData) &&
        Objects.equals(this.userDataBase64, v1VmCloudInitNoCloudSource.userDataBase64);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1VmCloudInitNoCloudSource {\n");
