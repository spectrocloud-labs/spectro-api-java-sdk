...
import com.spectrocloud.client.model.V1AwsSubnetEntity;
...
public class V1AwsMachinePoolCloudConfigEntity {
  @SerializedName("azs")
  ...
  private List<V1AwsSubnetEntity> subnets = null;

  public V1AwsMachinePoolCloudConfigEntity azs(List<String> azs) {
    this.azs = azs;
    return this;
  }

  public V1AwsMachinePoolCloudConfigEntity addAzsItem(String azsItem) {
    if (this.azs == null) {
  ...
  **/
  ...
  public V1AwsMachinePoolCloudConfigEntity capacityType(CapacityTypeEnum capacityType) {
  ...
  **/
  ...
  public V1AwsMachinePoolCloudConfigEntity instanceType(String instanceType) {
   ...
   * @return instanceType
  **/
  @Schema(required = true, description = "instance type")
  ...
  public V1AwsMachinePoolCloudConfigEntity rootDeviceSize(Long rootDeviceSize) {
  ...
  **/
  ...
  public V1AwsMachinePoolCloudConfigEntity spotMarketOptions(V1SpotMarketOptions spotMarketOptions) {
  ...
  **/
  ...
  public V1AwsMachinePoolCloudConfigEntity subnets(List<V1AwsSubnetEntity> subnets) {
    this.subnets = subnets;
    return this;
  }

  public V1AwsMachinePoolCloudConfigEntity addSubnetsItem(V1AwsSubnetEntity subnetsItem) {
    if (this.subnets == null) {
      this.subnets = new ArrayList<V1AwsSubnetEntity>();
    }
  ...
  **/
  @Schema(description = "")
  public List<V1AwsSubnetEntity> getSubnets() {
    return subnets;
  }

  public void setSubnets(List<V1AwsSubnetEntity> subnets) {
    this.subnets = subnets;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1AwsMachinePoolCloudConfigEntity v1AwsMachinePoolCloudConfigEntity = (V1AwsMachinePoolCloudConfigEntity) o;
    return Objects.equals(this.azs, v1AwsMachinePoolCloudConfigEntity.azs) &&
        Objects.equals(this.capacityType, v1AwsMachinePoolCloudConfigEntity.capacityType) &&
        Objects.equals(this.instanceType, v1AwsMachinePoolCloudConfigEntity.instanceType) &&
        Objects.equals(this.rootDeviceSize, v1AwsMachinePoolCloudConfigEntity.rootDeviceSize) &&
        Objects.equals(this.spotMarketOptions, v1AwsMachinePoolCloudConfigEntity.spotMarketOptions) &&
        Objects.equals(this.subnets, v1AwsMachinePoolCloudConfigEntity.subnets);
  }

  @Override
  public int hashCode() {
    return Objects.hash(azs, capacityType, instanceType, rootDeviceSize, spotMarketOptions, subnets);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1AwsMachinePoolCloudConfigEntity {\n");
