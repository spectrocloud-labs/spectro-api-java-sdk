...
public class V1VsphereClusterConfigEntity {
  ...
  private V1VspherePlacementConfigEntity placement = null;
  ...
  public V1VsphereClusterConfigEntity controlPlaneEndpoint(V1ControlPlaneEndPoint controlPlaneEndpoint) {
  ...
  **/
  ...
  public V1VsphereClusterConfigEntity ntpServers(List<String> ntpServers) {
    this.ntpServers = ntpServers;
    return this;
  }

  public V1VsphereClusterConfigEntity addNtpServersItem(String ntpServersItem) {
  ...
  **/
  ...
  public V1VsphereClusterConfigEntity placement(V1VspherePlacementConfigEntity placement) {
  ...
  **/
  ...
  public V1VspherePlacementConfigEntity getPlacement() {
    return placement;
  }

  public void setPlacement(V1VspherePlacementConfigEntity placement) {
    this.placement = placement;
  }

  public V1VsphereClusterConfigEntity sshKeys(List<String> sshKeys) {
    this.sshKeys = sshKeys;
    return this;
  }

  public V1VsphereClusterConfigEntity addSshKeysItem(String sshKeysItem) {
  ...
  **/
  ...
  public V1VsphereClusterConfigEntity staticIp(Boolean staticIp) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1VsphereClusterConfigEntity v1VsphereClusterConfigEntity = (V1VsphereClusterConfigEntity) o;
    return Objects.equals(this.controlPlaneEndpoint, v1VsphereClusterConfigEntity.controlPlaneEndpoint) &&
        Objects.equals(this.ntpServers, v1VsphereClusterConfigEntity.ntpServers) &&
        Objects.equals(this.placement, v1VsphereClusterConfigEntity.placement) &&
        Objects.equals(this.sshKeys, v1VsphereClusterConfigEntity.sshKeys) &&
        Objects.equals(this.staticIp, v1VsphereClusterConfigEntity.staticIp);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1VsphereClusterConfigEntity {\n");
