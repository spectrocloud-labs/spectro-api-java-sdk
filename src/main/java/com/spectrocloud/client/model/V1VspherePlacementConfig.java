...
import com.spectrocloud.client.model.V1VsphereNetworkConfig;
...
public class V1VspherePlacementConfig {
  ...
  private V1VsphereNetworkConfig network = null;
  ...
  public V1VspherePlacementConfig cluster(String cluster) {
  ...
  **/
  ...
  public V1VspherePlacementConfig datacenter(String datacenter) {
  ...
  **/
  ...
  public V1VspherePlacementConfig datastore(String datastore) {
  ...
  **/
  ...
  public V1VspherePlacementConfig folder(String folder) {
    this.folder = folder;
    return this;
  }
  ...
  **/
  ...
  public V1VspherePlacementConfig imageTemplateFolder(String imageTemplateFolder) {
  ...
  **/
  ...
  public V1VspherePlacementConfig network(V1VsphereNetworkConfig network) {
  ...
  **/
  @Schema(description = "")
  public V1VsphereNetworkConfig getNetwork() {
    return network;
  }

  public void setNetwork(V1VsphereNetworkConfig network) {
    this.network = network;
  }

  public V1VspherePlacementConfig resourcePool(String resourcePool) {
  ...
  **/
  ...
  public V1VspherePlacementConfig storagePolicyName(String storagePolicyName) {
  ...
  **/
  ...
  public V1VspherePlacementConfig uid(String uid) {
    this.uid = uid;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1VspherePlacementConfig v1VspherePlacementConfig = (V1VspherePlacementConfig) o;
    return Objects.equals(this.cluster, v1VspherePlacementConfig.cluster) &&
        Objects.equals(this.datacenter, v1VspherePlacementConfig.datacenter) &&
        Objects.equals(this.datastore, v1VspherePlacementConfig.datastore) &&
        Objects.equals(this.folder, v1VspherePlacementConfig.folder) &&
        Objects.equals(this.imageTemplateFolder, v1VspherePlacementConfig.imageTemplateFolder) &&
        Objects.equals(this.network, v1VspherePlacementConfig.network) &&
        Objects.equals(this.resourcePool, v1VspherePlacementConfig.resourcePool) &&
        Objects.equals(this.storagePolicyName, v1VspherePlacementConfig.storagePolicyName) &&
        Objects.equals(this.uid, v1VspherePlacementConfig.uid);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1VspherePlacementConfig {\n");
