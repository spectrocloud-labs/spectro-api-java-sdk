 ...
 */
@Schema(description = "List of AWS instance types")


public class V1AwsInstanceTypes {
  @SerializedName("instanceTypes")
  private List<V1InstanceType> instanceTypes = null;

  public V1AwsInstanceTypes instanceTypes(List<V1InstanceType> instanceTypes) {
    this.instanceTypes = instanceTypes;
    return this;
  }

  public V1AwsInstanceTypes addInstanceTypesItem(V1InstanceType instanceTypesItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1AwsInstanceTypes v1AwsInstanceTypes = (V1AwsInstanceTypes) o;
    return Objects.equals(this.instanceTypes, v1AwsInstanceTypes.instanceTypes);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1AwsInstanceTypes {\n");
