...
public class V1VmRTCTimer {
  ...
  public V1VmRTCTimer present(Boolean present) {
  ...
  **/
  ...
  public V1VmRTCTimer tickPolicy(String tickPolicy) {
   ...
   * @return tickPolicy
  **/
  @Schema(description = "TickPolicy determines what happens when QEMU misses a deadline for injecting a tick to the guest. One of \"delay\", \"catchup\".")
  ...
  public V1VmRTCTimer track(String track) {
    this.track = track;
    return this;
  }
   ...
   * @return track
  **/
  @Schema(description = "Track the guest or the wall clock.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1VmRTCTimer v1VmRTCTimer = (V1VmRTCTimer) o;
    return Objects.equals(this.present, v1VmRTCTimer.present) &&
        Objects.equals(this.tickPolicy, v1VmRTCTimer.tickPolicy) &&
        Objects.equals(this.track, v1VmRTCTimer.track);
  }
