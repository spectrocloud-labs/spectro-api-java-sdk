 ...
 */
@Schema(description = "List of Azure instance types")


public class V1AzureInstanceTypes {
  @SerializedName("instanceTypes")
  private List<V1InstanceType> instanceTypes = null;

  public V1AzureInstanceTypes instanceTypes(List<V1InstanceType> instanceTypes) {
    this.instanceTypes = instanceTypes;
    return this;
  }

  public V1AzureInstanceTypes addInstanceTypesItem(V1InstanceType instanceTypesItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1AzureInstanceTypes v1AzureInstanceTypes = (V1AzureInstanceTypes) o;
    return Objects.equals(this.instanceTypes, v1AzureInstanceTypes.instanceTypes);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1AzureInstanceTypes {\n");
