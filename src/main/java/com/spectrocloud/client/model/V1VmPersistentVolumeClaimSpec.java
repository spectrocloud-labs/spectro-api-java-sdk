...
public class V1VmPersistentVolumeClaimSpec {
  ...
  private V1VmTypedLocalObjectReference dataSourceRef = null;
  ...
  public V1VmPersistentVolumeClaimSpec accessModes(List<String> accessModes) {
    this.accessModes = accessModes;
    return this;
  }

  public V1VmPersistentVolumeClaimSpec addAccessModesItem(String accessModesItem) {
  ...
  **/
  ...
  public V1VmPersistentVolumeClaimSpec dataSource(V1VmTypedLocalObjectReference dataSource) {
  ...
  **/
  ...
  public V1VmPersistentVolumeClaimSpec dataSourceRef(V1VmTypedLocalObjectReference dataSourceRef) {
  ...
  **/
  @Schema(description = "")
  public V1VmTypedLocalObjectReference getDataSourceRef() {
    return dataSourceRef;
  }

  public void setDataSourceRef(V1VmTypedLocalObjectReference dataSourceRef) {
    this.dataSourceRef = dataSourceRef;
  }

  public V1VmPersistentVolumeClaimSpec resources(V1VmCoreResourceRequirements resources) {
  ...
  **/
  ...
  public V1VmPersistentVolumeClaimSpec selector(V1VmLabelSelector selector) {
  ...
  **/
  ...
  public V1VmPersistentVolumeClaimSpec storageClassName(String storageClassName) {
  ...
  **/
  ...
  public V1VmPersistentVolumeClaimSpec volumeMode(String volumeMode) {
  ...
  **/
  ...
  public V1VmPersistentVolumeClaimSpec volumeName(String volumeName) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1VmPersistentVolumeClaimSpec v1VmPersistentVolumeClaimSpec = (V1VmPersistentVolumeClaimSpec) o;
    return Objects.equals(this.accessModes, v1VmPersistentVolumeClaimSpec.accessModes) &&
        Objects.equals(this.dataSource, v1VmPersistentVolumeClaimSpec.dataSource) &&
        Objects.equals(this.dataSourceRef, v1VmPersistentVolumeClaimSpec.dataSourceRef) &&
        Objects.equals(this.resources, v1VmPersistentVolumeClaimSpec.resources) &&
        Objects.equals(this.selector, v1VmPersistentVolumeClaimSpec.selector) &&
        Objects.equals(this.storageClassName, v1VmPersistentVolumeClaimSpec.storageClassName) &&
        Objects.equals(this.volumeMode, v1VmPersistentVolumeClaimSpec.volumeMode) &&
        Objects.equals(this.volumeName, v1VmPersistentVolumeClaimSpec.volumeName);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1VmPersistentVolumeClaimSpec {\n");
